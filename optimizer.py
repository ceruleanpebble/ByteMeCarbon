...
def optimize(tree, remove_unused=False):
    ...
    7. Unused Function Removal: (optional) Remove functions that are never called
    ...
    # NOTE: remove_unused_apis disabled by default (too aggressive for single-file scenarios)
    # tree = optimize_remove_unused_apis(tree, project_root='.', enable=False)
